...
(function() {
  ...
  module.exports = FSTree = (function(_super) {
    ...
    function FSTree(root, filter) {
      ...
      this.root = root;
      this.filter = this._parseFilter(filter);
      this._files = [];
      this._folders = [];
      this._errors = [];
      (function(__iced_k) {
    ...
    FSTree.prototype.setFilter = function(filter) {
      this.filter = this._parseFilter(filter);
      return this.update(null, null);
    };

    FSTree.prototype._parseFilter = function(filter) {
      if (!filter) {
        return {
          matches: (function() {
            return true;
      ...
      } else if ((typeof filter.matches === 'function') && (typeof filter.excludes === 'function')) {
        return filter;
      } else {
    ...
    FSTree.prototype.update = function(folder, item) {
      ...
      if (!this._updateInProgress) this._performQueuedUpdate();
    };
      ...
      (function(__iced_k) {
        ...
        for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
          ...
          if (oldFiles.hasOwnProperty(relpath)) {
            ...
            if (!file.equals(old)) change.modifiedFiles.push(relpath);
            if (!file.equals(old)) {
        ...
        for (_l = 0, _len3 = _ref3.length; _l < _len3; _l++) {
          ...
          if (oldFolders.hasOwnProperty(relpath)) {
            ...
            if (!folder.equals(old)) change.modifiedFolders.push(relpath);
        ...
        if (!change.isEmpty()) _this.emit('change', change);
        _this._updateInProgress = false;
        if (_this._updateRequested) return _this._performQueuedUpdate();
      });
    };
