...
(function() {
  ...
  FSMonitorTool = (function() {
    ...
    FSMonitorTool.prototype.handleChange = function(change) {
      if (this.print) this.printChange(change);
      if (this.command.length > 0) return this.executeCommandForChange(change);
    };
  ...
  exports.run = function(argv) {
    ...
    app.startMonitoring();
    if (app.prerun) app.executeCommandForChange({});
    if (!app.quiet) return app.printOptions();
  };
